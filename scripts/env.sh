...
export STREAM_FILE=Classroom_1080_30fps_3000_frames.h264

export OUTPUT_PATH=/tmp/
export OUTPUT_FILE=out.yuv

export MEDIA_PATH=${WORK_DIR}/../../applications.media.gui.mips/content

# export FFMPEG_PATH=${WORK_DIR}/libraries.media.middleware.cartwheel.ffmpeg/ffmpeg
export FFMPEG_PATH=${WORK_DIR}/../../FFmpeg
...
MEDIA=${MEDIA_PATH}/Classroom_1080_30fps_3000_frames.h264
